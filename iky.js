...
////< DAFTAR BUTTON BY follow @Ferdii_Adss > ////

const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan ${botName} Verify Terlebih Dahulu Ya `
const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Kak\  Ferdii_adss```'
...
kalo gamuncul button ketik #allmenu atau #command

Flw: instagram.com/Ferdii_Adss/ `
...
▹ ${prefix}wallgravity text1 text2
 `
                                sendButMessage(from, wibu, `created follow @Ferdii_Adss`, [
                                {
...
▹ pubg text1 text2`
          ...
          buttonsMessage = {footerText:'follow @Ferdii_Adss', imageMessage: imageMsg,
...
▹ ${prefix}bokep25
 `
    ...
    sendButMessage(from, menu, `created follow @Ferdii_Adss`, [
    {
      buttonId: noprefix ? "menu" : "!"+"menu",
      buttonText: {
        displayText: `⬡ BACK TO MENU `,
  ...
  if (!isOwner) return reply(mess.only.owner)
    if (args.length < 1) return reply(`Penggunaan :\n*${prefix}sewa* add/del waktu`)
      ...
      *「Ferdii adss 」*`
      ...
      setTimeout( () => {
       ikyy.updatePresence(from, Presence.composing)
       reply(`*Terimakasih Telah Terdaftar Di Goib Botz *`)
     }, 2000)
      break
      case 'sfire1':{
...
case 'premium': 
  ...
  break
  case 'dana':
  gopeynya = `https://telegra.ph/file/6a1a5ac3ceabaebe61f15.jpg`
  buff = await getBuffer(gopeynya)
  teksnya = `
  Hai kak ${pushname}
  ...
  AN: Ferdiansyah Ah*** sapu***
  nomer dana  081808011667 qris gada
 ...
 Wa.me/6281217152804`
 sendButMessage(from, titid, `follow @Ferdii_Adss `, [
 {
...
case 'sc': 
case 'src':
textImg(`Bot ini menggunakan sc : https://youtube.com/channel/UCBkMF_D-V5Vs1y9VQ7cVTew`)
break
case 'ping':
case 'speed':
timestampe = speed();
...
case 'getpp':
if (kyy.message.extendedTextMessage === null || kyy.message.extendedTextMessage === undefined) {
 linkpp = await ikyy.getProfilePicture(from) || "https://telegra.ph/file/9d51e76e2df2c6c026dcf.jpg"
 ...
 linkpp = await ikyy.getProfilePicture(mberr) || "https://telegra.ph/file/9d51e76e2df2c6c026dcf.jpg"
 buffer = await getBuffer(linkpp)
...
case 'del':
       ...
       break
        ...
        urlinfo = 'https://telegra.ph/file/4a99a0e477770354279d8.jpg'
...
//------------------< Menunya Bang:v >-------------------
case 'infoig':
reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/Ferdii_Adss/`)
break
case 'ikyygroup':
reply('https://chat.whatsapp.com/Eerh1lb7R6bBpxFvR8jLlx')
break
