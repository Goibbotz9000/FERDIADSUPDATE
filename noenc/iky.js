...
`
   sendButMessage(from, wibu, `created iky ads`, [
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Follow @ikyy_ads`},type:1}]
...
case 'xnxx':
    ...
    break
      ...
      case 'tiktokaudio':
             ...
             ikyy.sendMessage(from, ikymemek, audio, { mimetype: Mimetype.mp4Audio, quoted: freply })()
             break
      case 'fbdl':
      case 'fb':
      case 'facebok':
...
break
      case 'triggered':
                    ...
                    exec(`wget "${ini_buffer}" -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
                        ...
                        ikyy.sendMessage(from, buff, sticker, { quoted: freply }).then(() => {
                            fs.unlinkSync(rano)
                        })
                    })
                    break
